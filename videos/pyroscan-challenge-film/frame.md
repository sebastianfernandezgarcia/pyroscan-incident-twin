...
typography:
  ...
  stat-value:{ fontFamily: "Inter", cqw: 5.5, weight: 700, lineHeight: 1.0, tracking: "-0.04em" }
  ...
  fadelist-title:{ fontFamily: "Inter", cqw: 10.5, weight: 700, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "Inter", cqw: 13.0, weight: 700, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
- **Weights** — the brand font ships `{400, 500, 580, 590, 600, 620, 650, 700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
