...
| Video under three minutes, with audio and clear WebMCP demo | **PASS** | The [public YouTube demo](https://youtu.be/4UGTdkSJ1Jg) is 2:54, processed at 2160p 4K, contains audible English narration and a quiet Cosmic Pulse bed at −15.9 LUFS / −1.5 dBTP programme level, and shows the complete WebMCP journey. See [`FINAL_VIDEO_RECEIPT.md`](FINAL_VIDEO_RECEIPT.md). |
| Submission materials in English | **PASS** | App, repository, description, testing instructions, captions and narration are English. |
| No unauthorized marks, music or media | **PASS** | Original interface and animation. Cosmic Pulse was generated by the project owner in their Magnific Personal workspace with Google Lyria 3 Pro; its source and SHA-256 are recorded in the media provenance. OpenStreetMap, Copernicus EMSR671 and SITCAN/GRAFCAN public-data attributions are visible/source-linked and documented. |
